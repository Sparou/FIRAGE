...
AExtendedCharacter::AExtendedCharacter()
{
    ...
    HealthComponent = CreateDefaultSubobject<USTUHealthComponent>(TEXT("Health Component"));
...
void AExtendedCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
